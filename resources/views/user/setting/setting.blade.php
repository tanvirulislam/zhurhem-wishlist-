        ...
        <div class="row">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">About Setting</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill" href="#custom-content-below-messages" role="tab" aria-controls="custom-content-below-messages" aria-selected="false">Password setting</a>
              </li>
            ...
            <div class="tab-content" id="custom-content-below-tabContent">
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  <img class="profile-user-img img-fluid img-circle" src="{{ asset('user-photo/'. Auth::user()->image) }}" alt="User profile picture">
                  @else
                  <p class="text-danger">please upload Your Image</p>
                  @endif
                </div>
              ...
              <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                <br>
                 <form method="POST" action="{{ url('/') }}/user/profile-update/{{ Auth::user()->id  }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                   {{ method_field('PUT') }} 
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                  ...
                                                  <input type="hidden" class="form-control" name="id" value="{{ Auth::user()->id }}" placeholder="Post Title">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="email_address_2" class="form-control" placeholder="Enter your email address" name="phone" value="{{ Auth::user()->phone }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
