  ...
  <div class="container-fluid">
   <div class="row clearfix">
    <div class="col-lg-4 col-md-4 col-sm-4">
      ...
      <a href="{{ route('admin.currency.create') }}" type="button"  class="btn btn-raised btn-primary waves-effect" >Add currency</a>
      @endif
    </div>
        ...
        <div class="body">
          ...
          <tbody>
            ...
            <tr>
             ...
             <td>{{ $categories->currency_code }}</td>
             <td>{{ $categories->exchange_rate }}</td>
            ...
            <td>
              ...
              <a class="btn btn-success text-white" href="{{ route('admin.currency.edit', $categories->id) }}"><i class="material-icons">build</i></a>
              @endif
              @if (Auth::guard('admin')->user()->can('currency.delete'))
              ...
              <form id="delete-form-{{ $categories->id }}" action="{{ route('admin.currency.delete',$categories->id) }}" method="POST" style="display: none;">
                @method('DELETE')
                @csrf
