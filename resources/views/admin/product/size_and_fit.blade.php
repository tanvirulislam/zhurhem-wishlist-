        ...
        <div class="row clearfix mt-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                         <form action="{{ route('admin.product.size_fit_store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8 col-sm-12">
                                ...
                                <input type="text" name="size_and_fit[]" placeholder="Enter cloth size" class="form-control" id="exampleFormControlInput1" >
                            </div>
