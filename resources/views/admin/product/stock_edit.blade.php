        ...
        <div class="row clearfix mt-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                     <form action="{{ route('admin.product.stock_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <label for="exampleFormControlInput1"><b>Stock</b></label>
                        <!-- <textarea id="ckeditor" name="stock" >{{$feature->stock}}</textarea> -->
                        <input type="text" value="{{$feature->stock}}" class="form-control" name="stock" placeholder="Enter Name">
