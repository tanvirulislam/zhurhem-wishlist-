        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item">Update detail and care</li>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix mt-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>Update detail and care</h2>
                       
                    </div>
                    <div class="body">
                         <form action="{{ route('admin.product.detail_care_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        @foreach($size_fit as $size_fits)
                            <div class="form-group col-md-8 col-sm-12">
                                ...
                                <input type="text" name="detail_and_care[]" value="{{$size_fits->detail_and_care}}"  placeholder="Enter cloth size" class="form-control" id="exampleFormControlInput1" >
                            </div>
                       @endforeach
                        <div class="col-md-4">
...
@section('scripts')
    ...
    var fieldHTML = '<div class="form-row"><div class="form-group col-md-6 col-sm-12"><label for="exampleFormControlInput1"><b>Size and fit</b></label><input type="text" name="detail_and_care[]" placeholder="Enter detail and care" class="form-control" id="exampleFormControlInput1" ></div></div>';
