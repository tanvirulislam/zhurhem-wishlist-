    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix mt-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>Add detail and care</h2>
                       
                    </div>
                    <div class="body">
                         <form action="{{ route('admin.product.detail_store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" value="{{Session::get('productId')}}" name="product_id">

                        <div class="form-row">
                            <div class="form-group col-md-8 col-sm-12">
                                <label for="exampleFormControlInput1"><b>Detail and care</b></label>
                                <input type="text" name="detail_and_care[]" placeholder="Enter detail and care" class="form-control" id="exampleFormControlInput1" >
                            </div>
...
@section('scripts')
    ...
    var fieldHTML = '<div class="form-row"><div class="form-group col-md-6 col-sm-12"><label for="exampleFormControlInput1"><b>Detail and care</b></label><input type="text" name="detail_and_care[]" placeholder="Enter detail and care" class="form-control" id="exampleFormControlInput1" ></div></div>';
